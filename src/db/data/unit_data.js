export default (() => {
  ...
  return [
    ...
    c(111801, 'ペコリーヌ（ニューイヤー）', 'ぺこりーぬ', 3, 450, 248, 1, 1.965, '【物理】前衛で元気いっぱいに新年を祝う腹ペコお姫様。\n物理攻撃力を高めるスキルで味方を強化し、ＨＰが多い\nほどダメージが上昇するユニオンバーストで敵を討つ。'),
    ...
    c(114301, 'トモ（マジカル）', 'とも', 3, 450, 402, 1, 2.0, '【物理】中衛で正義の力を魔法にのせて戦う魔法剣士。\n自身の物理攻撃力を魔法攻撃力に加える魔法少女の力と、\nたゆまぬ努力で獲得した剣技で、華麗な魔法攻撃を放つ。'),
    c(114401, 'アキノ（クリスマス）', 'あきの', 3, 450, 189, 1, 2.0, '【物理】前衛で味方のサポートを力に戦う、聖夜の令嬢。\nステータスアップ効果を受けると増加する【聖夜の煌き】\nでスキルを大きく強化し、聖夜を彩る強烈な一撃を放つ。'),
    c(114501, 'サレン（クリスマス）', 'されん', 3, 450, 150, 1, 2.09, '【物理】前衛で、光を操り味方を守る聖夜のサレンママ。\n敵の攻撃を防ぎ、ダメージを与えるユニオンバーストや、\nダメージを与えつつ回復するスキルで、攻守双方を担う。'),
    c(114601, 'ユカリ（クリスマス）', 'ゆかり', 1, 450, 408, 1, 2.09, '【物理】中衛で物理キャラを支援し戦う聖夜の元聖騎士。\n魔法攻撃力の高い敵単体のＴＰ減少や周囲の味方の魔法\n防御力アップスキルで、対魔法戦で無類の輝きを放つ。'),
    c(114701, 'ムイミ（ニューイヤー）', 'むいみ', 1, 450, 138, 1, 2.0, '【物理】前衛で、新風纏う「天楼覇断剣」を振るう少女。\n皆より一足遅れて突撃し、敵の前衛を吹き飛ばした後、\n強化した範囲物理攻撃で、ダンゴになった敵を斬り払う。'),
    c(115001, 'ネネカ（ニューイヤー）', 'ねねか', 3, 450, 562, 2, 2.07, '【魔法】中衛で艶やかな晴れ着を身に纏う『変貌大妃』。\n味方の魔法攻撃力アップやＨＰ、ＴＰを回復させるスキル\nで攻守にわたってサポートし苛烈な戦況でも勝利に導く。'),
    c(180101, 'ヒヨリ（プリンセス）', 'ひより', 3, 450, 199, 1, 1.62, '【物理】前衛で炎翼を背に敵を粉砕する、陽気な元気娘。\n戦いが続く程に自身の攻撃能力を強めるスキルを操り、\n高めた力で放つ超爆の一撃は、あらゆる敵を塵と化す。'),
