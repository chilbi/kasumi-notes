export default (() => {
  ...
  return [
    ...
    c(101401, 'カスミ', '15', '自警団（カォン）', '獣人族', '152', '41', '11', '3', 'AB', '読書、推理', '水瀬いのり', '頭脳明晰な美少女名探偵', 'test', '10'),
    ...
    c(106401, 'シェフィ', '??', '美食殿', 'ドラゴン族', '147', '???', '?', '?', '?', '読書、ストレッチ', '近藤玲奈', '記憶喪失のドラゴン娘', '', '1'),
    ...
    c(111801, 'ぺコリーヌ（ニューイヤー）', '17', '美食殿', 'ヒューマン', '156', '46', '3', '31', 'O', '食べ歩き、料理', 'M・A・O', 'いつも元気な腹ペコ少女', 'あ、あの…何か食べ物持っていませんか？\nもう、お腹ペコペコで…', '1'),
    ...
    c(112201, 'カスミ（マジカル）', '15', '自警団（カォン）', '獣人族', '152', '41', '11', '3', 'AB', '読書、推理', '水瀬いのり', '頭脳明晰な美少女名探偵', '', '10'),
    ...
    c(115001, 'ネネカ（ニューイヤー）', '24', '？？？', 'エルフ', '149', '??', '3', '24', 'O', '物真似、芸術鑑賞', '井口裕香', '研究所に隠れ住む物静かなお姉さん', '', ''),
    c(115501, 'コッコロ（儀装束）', '11', '美食殿', 'エルフ', '140', '35', '5', '11', 'B', '瞑想、動植物の飼育', '伊藤美来', '主を慕う、小さなガイド役', '主さまのガイド役を仰せつかりました\nわたくし、主さまに満足していただけるよう\n誠心誠意尽くさせていただきます', '1'),
    c(115601, 'ユイ（儀装束）', '17', 'トゥインクルウィッシュ', 'ヒューマン', '158', '47', '4', '5', 'O', '料理、人間観察', '種田梨沙', '戦闘のサポートが得意な、心優しい少女', 'あんまり役に立てるかはわからないけど…\nわたしも頑張って、\nみんなをサポートするね！', '2'),
    c(115701, 'カスミ（サマー）', '15', '自警団（カォン）', '獣人族', '152', '41', '11', '3', 'AB', '読書、推理', '水瀬いのり', '頭脳明晰な美少女名探偵', '', '10'),
    c(115801, 'リマ（シンデレラ）', '18', '牧場（エリザベスパーク）', '獣人族', '150', '100', '3', '14', 'A', '毛繕い、お喋り', '徳井青空', '乙女チックなもふもふアニマル', '私、ごく普通の、どこにでもいる女の子よ！\nみ、見た目以外はね…', '11'),
    c(115901, 'マコト（シンデレラ）', '17', '自警団（カォン）', '獣人族', '168', '54', '8', '9', 'O', 'お菓子作り', '小松未可子', '男勝りで情に厚いワイルド娘', '腹へってたら言えよな\n簡単でよければ\nすっげー旨いもん食わせてやるよ！', '10'),
    c(116001, 'マホ（シンデレラ）', '16', '自警団（カォン）', '獣人族', '155', '42', '9', '22', 'O', '空想、ぬいぐるみ集め', '内田真礼', 'マホマホ王国のプリンセス', 'マホマホ王国のお姫はんの、マホ姫どす！\nけったいな顔してどないしはったん？\nマホマホ王国はずーっと遠くの国なんどす？', '10'),
    c(116201, 'クロエ（聖学祭）', '17', '聖テレサ女学院（なかよし部）', 'エルフ', '154', '42', '8', '7', 'O', 'ダーツ', '種﨑敦美', 'ダウンタウン育ちのダウナー系エルフ', '', '16'),
    c(116301, 'チエル（聖学祭）', '16', '聖テレサ女学院（なかよし部）', 'ヒューマン', '156', '46', '9', '15', 'O', 'ダンス、カラオケ', '佐倉綾音', '自由奔放ナチュラル無礼な現代っ子', '', '16'),
    c(116501, 'イノリ（タイムトラベル）', '13', 'ドラゴンズネスト', 'ドラゴン族', '145', '???', '9', '29', 'AB', 'ゲーム', '藤田茜', '口が達者なヘタレドラゴン', '', '17'),
    ...
    c(180601, 'キャル（プリンセス）', '14', '美食殿', '獣人族', '152', '39', '9', '2', 'A', '猫と遊ぶ', '立花理香', '行き倒れの謎のネコミミ魔法使い', 'なに、モタモタしてんのよ\n仕方ないから、あたしが手伝ってあげるわ\nいい？　感謝しなさいよね！', '1')
  ];
})();
